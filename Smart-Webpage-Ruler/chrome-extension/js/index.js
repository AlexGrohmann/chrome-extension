(() => {
  ...
  // src/js/handlers/listeners.js
  var import_jquery2 = __toESM(require_jquery(), 1);

  // src/js/ruler/draw.js
  var import_jquery = __toESM(require_jquery(), 1);
  var drawRuller = (measures, { axis: { top, left }, width, height }) => {
    ...
    Object.entries(measures).forEach(([direction, style]) => {
      ...
      if (directionShouldHaveLabel.includes(direction)) {
        ...
        const style2 = direction === "top" ? `left:${left + width / 2 - 20}px; top:-32px;` : `top:${top + height / 2 - 10}px; left: 7px;`;
        label = `<span class="rb-zeplin-ruler-label rb-zeplin-ruler-label-${direction}" style="${style2}">${measure}px</span>`;
      }
      const ruller = (0, import_jquery.default)(
        `<div class="rb-zeplin-ruller rb-zeplin-ruller-${direction}" style="${fullHeightStyle}">
            ${label}
            </div>`
      );
      ruller.css(style);
      (0, import_jquery.default)("body").append(ruller);
    });
  };
  var clearRuller = () => {
    (0, import_jquery.default)(".rb-zeplin-ruller").remove();
  };
  var clearRullerLabel = () => {
    (0, import_jquery.default)(".rb-zeplin-ruler-label").remove();
  };
  var drawDistanceLine = ({
    ...
    const veriticalLine = (0, import_jquery.default)(
      `<div class="rb-zeplin-distance-line rb-zeplin-distance-line-vertical"></div>`
    );
    const horizontalLine = (0, import_jquery.default)(
    ...
    if (heightOfVerticalGuide > 0) {
      veriticalLine.append(
        `<span class="rb-zeplin-guide-distance rb-zeplin-guide-distance-vertical">${Math.round(heightOfVerticalGuide)}px</span>`
      );
    }
    ...
    if (widthOfHorizontalGuide > 0) {
      horizontalLine.append(
        `<span class="rb-zeplin-guide-distance rb-zeplin-guide-distance-horizontal">${Math.round(widthOfHorizontalGuide)}px</span>`
      );
    }
    (0, import_jquery.default)("body").append(veriticalLine);
    (0, import_jquery.default)("body").append(horizontalLine);
  };
  var clearDistanceLine = () => {
    (0, import_jquery.default)(".rb-zeplin-distance-line").remove();
  };

  // src/js/ruler/measure.js
  var getRullerPosition = ({
  ...
  var getCentralPostion = ({ axis: { top, left }, width, height }) => {
  ...
  var getRelativeDistance = (positionOfFocused, positionOfSelected) => {
    const {
      axis: {
  ...
  var getAbsoluteDistance = (positionOfTargetElement, positionOfSourceElement) => {
    const {
  ...
  function getMeasuresOfElement(element) {
    var axis = (0, import_jquery2.default)(element).offset();
    var width = (0, import_jquery2.default)(element).innerWidth();
    var height = (0, import_jquery2.default)(element).innerHeight();
    return {
      axis,
      width,
      height
  ...
  var clickHandler = (event) => {
    ...
    event.preventDefault();
    event.stopPropagation();
    if ((0, import_jquery2.default)(".rb-zeplin-selected").length) {
      (0, import_jquery2.default)(".rb-zeplin-selected").removeClass("rb-zeplin-selected");
    }
    if ((0, import_jquery2.default)(".rb-zeplin-focused").length) {
      (0, import_jquery2.default)(".rb-zeplin-focused").removeClass("rb-zeplin-focused");
    }
    selectedElement = element;
    (0, import_jquery2.default)(element).addClass("rb-zeplin-selected");
    clearRuller();
    clearDistanceLine();
  ...
  var mouseEnterHanlder = (e) => {
    e.preventDefault();
    e.stopPropagation();
    clearRullerLabel();
    const node = e.target;
    if ((0, import_jquery2.default)(node).hasClass("rb-zeplin-selected")) {
      return;
    }
    if ((0, import_jquery2.default)(".rb-zeplin-focused").length) {
      (0, import_jquery2.default)(".rb-zeplin-focused").removeClass("rb-zeplin-focused");
    ...
    if (!(0, import_jquery2.default)(node).is(selectedElement)) {
      (0, import_jquery2.default)(node).addClass("rb-zeplin-focused");
    }
    clearDistanceLine();
    let distanceOfElements;
    if (selectedElement && focusedElement && ((0, import_jquery2.default)(selectedElement).has(focusedElement).length || (0, import_jquery2.default)(focusedElement).has(selectedElement).length)) {
      let targetElement, sourceElement;
      if ((0, import_jquery2.default)(selectedElement).has(focusedElement).length) {
  ...
  var ACTIVATE_APP = "ACTIVATE_APP";
  var DEACTIVATE_APP = "DEACTIVATE_APP";
  var TOGGLE_APP = "TOGGLE_APP";

  // src/js/handlers/messageHandler.js
  var initalizeEventSubscription = (onSubscribe, onUnSubscribe) => {
  ...
  // src/js/handlers/assetLoader.js
  var import_jquery3 = __toESM(require_jquery(), 1);

  // src/js/constants/assetList.js
  var CSSFilses = ["/css/main.css"];
  ...
  var includeCSS = () => {
    CSSFilses.forEach((file) => {
      ...
      (0, import_jquery3.default)("head").append(styleElement);
    });
  };
  var removeCSS = () => {
    (0, import_jquery3.default)('link[data="rb-zeplin-link"]').remove();
  };
  ...
  window.RB_ZEPLIN_RULLER_ENABLED = false;
  (0, import_jquery4.default)(document).ready(() => {
    initalizeEventSubscription(() => {
      (0, import_jquery4.default)("body").on("click", clickHandler);
      (0, import_jquery4.default)("*").on("mouseenter", mouseEnterHanlder);
      includeCSS();
    }, () => {
      (0, import_jquery4.default)("body").off("click", clickHandler);
      (0, import_jquery4.default)("*").off("mouseenter", mouseEnterHanlder);
      removeCSS();
    });
  });
})();
